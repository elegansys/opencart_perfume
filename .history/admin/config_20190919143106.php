<?php
// HTTP
define('HTTP_SERVER', 'http://192.168.1.8/git/perfume/admin/');
define('HTTP_CATALOG', 'http://192.168.1.8/git/perfume/');

// HTTPS
define('HTTPS_SERVER', 'http://192.168.1.8/git/perfume/admin/');
define('HTTPS_CATALOG', 'http://192.168.1.8/git/perfume/');
